...
def main_menu():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(320, 180), 
                            text_input="PLAY", font=get_font(25), base_color="#d7fcd4", hovering_color="#C7FF33")
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(320, 265), 
                            text_input="OPTIONS", font=get_font(25), base_color="#d7fcd4", hovering_color="#C7FF33")
        QUIT_BUTTON = Button(image=pygame.image.load("assets/Quit Rect.png"), pos=(320, 350), 
                            text_input="QUIT", font=get_font(25), base_color="#d7fcd4", hovering_color="#C7FF33")
